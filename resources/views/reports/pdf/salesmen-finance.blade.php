...
<html>
<head>
    <title>Salesmen Finance Report – {{ $salesmen->name }}</title>
    <style>
...
<body>
    <div class="header">
        <h2>Do'Zee — Salesmen Finance Report</h2>
    ...
    <div class="meta-info">
        <table>
            <tr>
                <td style="width:15%;font-weight:bold;">Salesmen Name:</td>
                <td style="width:35%;">{{ $salesmen->name }}</td>
                <td style="width:15%;font-weight:bold;">Export Date:</td>
                <td style="width:35%;">{{ now()->format('d M Y, h:i A') }}</td>
            </tr>
            <tr>
                <td style="font-weight:bold;">Username:</td>
                <td>{{ $salesmen->username }}</td>
