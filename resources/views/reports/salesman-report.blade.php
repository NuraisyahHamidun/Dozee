        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white dark:bg-slate-800 p-6 rounded-3xl border border-slate-100 dark:border-slate-700 shadow-sm">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    ...
                    <form action="{{ route('reports.salesman_personal.index') }}" method="GET" class="w-full md:w-auto flex flex-wrap items-end gap-3">
                        <div>
                        ...
                        <div class="flex gap-2">
                            ...
                            <a href="{{ route('reports.salesman_personal.index') }}" class="px-4 py-2 bg-slate-100 hover:bg-slate-200 dark:bg-slate-700 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-200 text-sm font-bold rounded-xl transition-all">
                                Reset
                            </a>
                        </div>
                    </form>
