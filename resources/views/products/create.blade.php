                    ...
                    <div class="space-y-8">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <input id="item_code" name="item_code" type="text" readonly
                                       ...
                                       value="{{ old('item_code', $nextItemCode) }}" />
                            ...
                            <div>
                                ...
                                <input id="item_name" name="item_name" type="text" 
                                       ...
                                       value="{{ old('item_name') }}" required autofocus placeholder="e.g. Ultra Clean Pro Liquid" />
                            ...
                            <div>
                                ...
                                <input id="volume" name="volume" type="text" 
                                       class="w-full px-5 py-4 bg-slate-50 dark:bg-slate-900 border-none rounded-2xl focus:ring-2 focus:ring-indigo-500 transition-all text-sm font-medium text-slate-700 dark:text-slate-200" 
                                       :value="old('volume')" required placeholder="e.g. 500ml" />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <input id="stock_qty" name="stock_qty" type="number" min="0"
                                       class="w-full px-5 py-4 bg-slate-50 dark:bg-slate-900 border-none rounded-2xl focus:ring-2 focus:ring-indigo-500 transition-all text-sm font-medium text-slate-700 dark:text-slate-200" 
                                       value="{{ old('stock_qty', 0) }}" required placeholder="0" />
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="4" 
                                      class="w-full px-5 py-4 bg-slate-50 dark:bg-slate-900 border-none rounded-2xl focus:ring-2 focus:ring-indigo-500 transition-all text-sm font-medium text-slate-700 dark:text-slate-200" 
                                      placeholder="Briefly describe the item...">{{ old('description') }}</textarea>
            ...
            if (toggle && input) {
                const handleToggle = function() {
                    if (toggle.checked) {
                        ...
                        input.value = "{{ old('item_code', $nextItemCode) }}";
                    }
                };
