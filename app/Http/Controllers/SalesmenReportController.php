...
class SalesmenReportController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('reports.salesmen-report', compact(
            'salesmen',
            'startDate',
            'endDate',
            'monthInput',
    ...
    public function export(Request $request)
    {
        ...
        if ($format === 'pdf') {
            $pdf = Pdf::loadView('reports.pdf.salesmen-pdf', compact(
                'salesmen',
                'startDate',
                'endDate',
                'saleItems',
        ...
        $callback = function() use ($saleItems, $startDate, $endDate, $salesmen, $myTotalSales, $myItemsSold, $myTotalTransactions) {
            echo '<html><body>';
            echo '<table border="1">';
            echo '<tr><th colspan="7" style="background-color: #8B5CF6; color: white;">SALES REPORT - ' . strtoupper($salesmen->name) . ' (' . $startDate . ' to ' . $endDate . ')</th></tr>';
            echo '<tr>
