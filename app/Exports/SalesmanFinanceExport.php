...
class SalesmanFinanceExport implements FromCollection, WithHeadings, WithMapping, WithTitle, ShouldAutoSize, WithStyles, WithColumnFormatting
{
    ...
    public function __construct($salesmanId, $startDate, $endDate, $promoId = null)
    {
    ...
    public function collection()
    {
        $query = SaleItem::with(['sale.salesman', 'product', 'promotion'])
            ->whereHas('sale', function($q) {
                $q->where('salesman_id', $this->salesmanId)
    ...
    public function map($saleItem): array
    {
        ...
        return [
            ...
            $saleItem->sale->salesman->name ?? 'N/A',
    ...
    {
        return 'Salesman Finance Report';
    }
}
